...
var num12 = 0;
cron.schedule('34 */12 * * *', () => {
      GetArticles(All_Keys13[num12],cat13);
     num12++;
...
var num13 = 0;
cron.schedule('36 */12 * * *', () => {
      GetArticles(All_Keys14[num13],cat14);
     num13++;
...
var num14 = 0;
cron.schedule('38 */12 * * *', () => {
      GetArticles(All_Keys15[num14],cat15);
     num14++;
...
var num15 = 0;
cron.schedule('40 */12 * * *', () => {
      GetArticles(All_Keys16[num15],cat16);
     num15++;
...
var num16 = 0;
cron.schedule('42 */12 * * *', () => {
      GetArticles(All_Keys17[num16],cat17);
     num16++;
...
var num17 = 0;
cron.schedule('44 */12 * * *', () => {
      GetArticles(All_Keys18[num17],cat18);
     num17++;
...
var num18 = 0;
cron.schedule('46 */12 * * *', () => {
      GetArticles(All_Keys19[num18],cat19);
     num18++;
...
var num19 = 0;
cron.schedule('48 */12 * * *', () => {
      GetArticles(All_Keys20[num19],cat20);
     num19++;
